...
-- 1. Önce trigger'ı kaldır (backfill INSERT sırasında tetiklenmesin)
DROP TRIGGER IF EXISTS odemeler_sync ON public.odemeler;
DROP FUNCTION IF EXISTS public.sync_odened_tutar();

-- 2. Eksik odemeler kaydı oluştur: odened_tutar > 0 ama odemeler satırı olmayanlar
...
-- 3. odened_tutar kolonunu kaldır
